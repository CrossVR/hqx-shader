...
void main()
{
    ...
    _index = vec2(float((_TMP5.xy*vec2( 2.55000000E+002, 6.00000000E+001)).x), float((_TMP5.xy*vec2( 2.55000000E+002, 6.00000000E+001)).y));
    _x0033 = _fp*2.00000000E+000;
    _TMP6 = floor(_x0033);
    _TMP7 = dot(_TMP6, vec2( 1.00000000E+000, 2.00000000E+000));
    _index.y = float((float(_index.y) + _TMP7));
    _c0037 = vec2(float((_index*vec2( 3.90625000E-003, 1.56250000E-002) + vec2( 1.95312500E-003, 7.81250000E-003)).x), float((_index*vec2( 3.90625000E-003, 1.56250000E-002) + vec2( 1.95312500E-003, 7.81250000E-003)).y));
