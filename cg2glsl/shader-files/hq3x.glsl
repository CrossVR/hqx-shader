...
void main()
{
    ...
    _fp = fract(_x0019);
    _a0021 = -5.00000000E-001 + _fp;
    _val0021 = vec2(float((_a0021.x > 0.00000000E+000)), float((_a0021.y > 0.00000000E+000)));
    _TMP0 = _val0021 - vec2(float((_a0021.x < 0.00000000E+000)), float((_a0021.y < 0.00000000E+000)));
    _quad = vec2(float(_TMP0.x), float(_TMP0.y));
    _ps = 1.00000000E+000/OrigTextureSize;
    ...
    _c0027 = TEX0.xy + vec2(_ps.x, 0.00000000E+000)*vec2(float(_quad.x), float(_quad.y));
    _TMP3 = COMPAT_TEXTURE(OrigTexture, _c0027);
    _c0029 = TEX0.xy + vec2(0.00000000E+000, _ps.y)*vec2(float(_quad.x), float(_quad.y));
    ...
    _index = vec2(float((_TMP5.xy*vec2( 2.55000000E+002, 1.35000000E+002)).x), float((_TMP5.xy*vec2( 2.55000000E+002, 1.35000000E+002)).y));
    _x0033 = _fp*3.00000000E+000;
    _TMP6 = floor(_x0033);
    _TMP7 = dot(_TMP6, vec2( 1.00000000E+000, 3.00000000E+000));
    _index.y = float((float(_index.y) + _TMP7));
    _c0037 = vec2(float((_index*vec2( 3.90625000E-003, 6.94274902E-003) + vec2( 1.95312500E-003, 3.47137451E-003)).x), float((_index*vec2( 3.90625000E-003, 6.94274902E-003) + vec2( 1.95312500E-003, 3.47137451E-003)).y));
    _TMP8 = COMPAT_TEXTURE(LUT, _c0037);
    _weights = vec4(float(_TMP8.x), float(_TMP8.y), float(_TMP8.z), float(_TMP8.w));
    _TMP10 = dot(vec4(float(_weights.x), float(_weights.y), float(_weights.z), float(_weights.w)), vec4( 1.00000000E+000, 1.00000000E+000, 1.00000000E+000, 1.00000000E+000));
    _sum = float(_TMP10);
    ...
    _ret_0 = vec4(_r0043.x, _r0043.y, _r0043.z, 1.00000000E+000);
    FragColor = _ret_0;
    return;
} 
#endif
